...
| adding a new workspace to orkester | copy the next free number + the shape of `01-homelab/` | new folder gets its own `CONTEXT.md`, add a row here and in `CONTEXT.md` |
